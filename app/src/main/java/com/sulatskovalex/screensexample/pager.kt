...
class PagScreen(presenter: PagPresenter,
                override val screenTag: String) : PagerScreen<PagScreen, PagPresenter, Unit>(presenter) {
...
class P2Screen(presenter: P2Presenter,
               override val screenTag: String) : Screen<P2Screen, P2Presenter, Unit>(presenter) {
...
class P3Screen(presenter: P3Presenter,
               override val screenTag: String) : Screen<P3Screen, P3Presenter, Unit>(presenter) {
